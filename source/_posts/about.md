...
Kotlin, Java, Ruby, TypeScript, JavaScript, Python, Go, Node.js, PHP, Solidity

### フレームワーク

Ruby on Rails, Next.js, Vue.js, Nuxt.js, Cordova, Laravel, Knockout.js
...
- ただほとんどのプロダクトは少なからずそういう一面があるとも思うのであまりフィルタにはならないかも
- 社内ツール開発とかはつらい

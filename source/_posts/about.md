...
住所が福岡県北九州市のはずれということもあり、基本的に出社は難しいです。  

### お客様との距離

お客様との距離が近い方が嬉しいです。
可能なら要検定義を直接お客様と打ち合わせできるとありがたいです。
BtoCの場合でも、自分で課題と解決策を提案したり、実行させて頂けると嬉しいです。
（自分で考えることが好きなので、降ってくるタスクをこなすだけ〜ということは苦手）

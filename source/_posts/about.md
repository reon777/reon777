...
エンジニア歴は８年目になります。
主な担当はWebアプリ開発（フロントエンド・バックエンド）とAndroidアプリ開発です。
...
TypeScript、JavaScript、Node.js、Kotlin、Java、Ruby、PHP、Solidity

### フレームワーク

Vue.js、Nuxt.js、Ruby on Rails、Cordova、Laravel、Knockout.js
...
（自分で考えることが好きなので、降ってくるタスクをこなすだけ〜ということはやりたくない）
